				...
				<form:form method="post" action="${url}"
					...
					<div class="col-sm-12">
						...
						<div class="form-group">
							...
							IOS
							<form:radiobutton path="productCategory" value="Camera"/>
							Camera
							<form:radiobutton path="productCategory" value="Earphone"/>
							Earphone
							<form:radiobutton path="productCategory" value="Windows"/>
							Windows
							<form:radiobutton path="productCategory" value="Video Game"/>
							Video Game
						</div>
						<div class="row">
