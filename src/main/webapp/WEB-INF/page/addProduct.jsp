				...
				<form:form method="post" action="${url}" modelAttribute="productForm">
					<div class="col-sm-12">
						...
						<form:label path="productCategory">Product Category</form:label>
								 ...
								 <form:radiobutton path="productCategory" value="Camera"/> Camera
								 <form:radiobutton path="productCategory" value="Earphone"/> Earphone
								 <form:radiobutton path="productCategory" value="Windows"/> Windows
							     <form:radiobutton path="productCategory" value="Video Game"/> Video Game
